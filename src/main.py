...
def ciw():
    ...
    parser_learn.add_argument('--weights-storage', required=False, default='ctr_in_woderland.ciw.DictStorage', help='Weights storage class')
    ...
    parser_learn.add_argument('--feature-filter', required=False, default="none", type=str, help='Filter features: none, poisson, bloom')
    parser_learn.add_argument('--subsampling', required=False, action="store_true", help='Toggle making subsampling for some group')
    ...
    parser_predict = subparsers.add_parser('validate', help='predict model')
    parser_predict.add_argument('--storage-predictions-dumping-depth', required=False, type=int, default=100000, help='Iterations before dump prediction')
